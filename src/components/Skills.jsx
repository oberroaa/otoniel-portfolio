...
export default function Skills() {
    ...
    const translations = {
        ...
        groups: [
            ...
            { title: { es: "Arquitectura Backend", en: "Backend Architecture" }, items: ["Node.js (NestJS/Express)", "Prisma ORM", "TypeORM", "PostgreSQL", "Supabase", "MongoDB Atlas", "Vector Databases"] },
            ...
            { title: { es: "Cloud & DevOps", en: "Cloud & DevOps" }, items: ["GitHub Actions (CI/CD)", "Vercel", "Docker", "Supabase BaaS", "Meta WhatsApp API", "Gmail API", "OAuth2/OpenID"] },
